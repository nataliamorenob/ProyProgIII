...
public class Productos implements Comparable{
	...
	protected Productos(String nombre, int precio, String animal_dirigido, String rutaFoto, boolean enCesta) {
		super();
		this.nombre = nombre;
		this.precio = precio;
	...
	protected Productos(String nombre, int precio, String animal_dirigido) {
		super();
		this.nombre = nombre;
		this.precio = precio;
		this.animal_dirigido = animal_dirigido;
